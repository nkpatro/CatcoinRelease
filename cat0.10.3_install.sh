...
#run_with_sudo apt install pkg-config -y
#run_with_sudo apt install autoconf automake libtool -y
#run_with_sudo apt-get install qt5-default qtcreator -y
#run_with_sudo apt install libdb5.3++-dev -y
#run_with_sudo apt install libprotobuf-dev protobuf-compiler -y
...
#wget -nc http://launchpadlibrarian.net/359703400/libboost-test1.65.1_1.65.1+dfsg-0ubuntu5_amd64.deb
#wget -nc http://launchpadlibrarian.net/359703338/libboost-test1.65-dev_1.65.1+dfsg-0ubuntu5_amd64.deb
...
#run_with_sudo dpkg -i ../libboost-test1.65.1_1.65.1+dfsg-0ubuntu5_amd64.deb
#run_with_sudo dpkg -i ../libboost-test1.65-dev_1.65.1+dfsg-0ubuntu5_amd64.deb


git clone https://github.com/nkpatro/CatcoinRelease.git
cd CatcoinRelease
git checkout test002
chmod +x autogen.sh share/genbuild.sh
./autogen.sh
./configure --prefix=/opt/catcoin
make
