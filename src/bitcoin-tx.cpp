...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Catcoin Core catcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  catcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded catcoin transaction") + "\n" +
              "  catcoin-tx [options] -create [commands]   " + _("Create hex-encoded catcoin transaction") + "\n" +
              "\n";
