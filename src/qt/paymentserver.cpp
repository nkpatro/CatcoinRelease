...
const char* BIP71_MIMETYPE_PAYMENT = "application/catcoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/catcoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/catcoin-paymentrequest";
