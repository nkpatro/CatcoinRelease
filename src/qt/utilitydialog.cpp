    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Catcoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About Catcoin Core"));
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Catcoin Core is shutting down...") + "<br /><br />" +
