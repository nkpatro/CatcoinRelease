...
void setupAddressWidget(QValidatedLineEdit *widget, QWidget *parent)
{
    ...
    widget->setPlaceholderText(QObject::tr("Enter a Catcoin address (e.g. %1)").arg("9nFe6PRe1QJcPByy2wFeoQwga5LX5JEeZv"));
#endif
...
bool parseBitcoinURI(QString uri, SendCoinsRecipient *out)
{
    ...
    if(uri.startsWith("catcoin://", Qt::CaseInsensitive))
    {
...
{
    QString ret = QString("catcoin:%1").arg(info.address);
    int paramCount = 0;
